          ...
          >
            ...
            <div className="flex-1 flex items-center justify-start pl-2">
              <button
                ...
                className="flex items-center justify-center p-2 rounded-xl bg-yellow-400/10 hover:bg-yellow-400/20 active:bg-yellow-400/30 border border-yellow-400/25 hover:border-yellow-400/50 active:scale-95 transition-all text-yellow-400 cursor-pointer"
                title="Lock Display Controls"
              >
                <Lock className="w-4 h-4 text-yellow-400 fill-yellow-400/25" />
              </button>
            </div>
          ...
          {isLocked && (
            ...
            >
              <button
                ...
                className={`w-12 h-12 sm:w-14 sm:h-14 rounded-full bg-slate-900/90 text-yellow-400 flex items-center justify-center shadow-2xl border border-yellow-400/40 hover:border-yellow-400 active:scale-90 transition-all duration-300 pointer-events-auto cursor-pointer focus-visible:outline-hidden ${
                  showLockFeedback ? 'scale-115 bg-slate-850 ring-4 ring-yellow-400/30 border-yellow-400 rotate-12' : 'scale-100'
                }`}
                title="Tap to Unlock display"
              >
                <Lock className="w-5.5 h-5.5 text-yellow-400 fill-yellow-400/20 animate-pulse" />
              </button>
            </div>
          )}
