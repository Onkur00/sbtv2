...
export const Login: React.FC<LoginProps> = ({ onLoginSuccess }) => {
  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-[#020617] via-[#0b1329] to-[#010409] flex flex-col justify-center items-center px-4 relative overflow-hidden select-none">
      ...
      <div className="w-full max-w-md relative z-10 transition-all duration-300">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-3xl font-black tracking-tight text-white font-sans">
            LIVE <span className="text-yellow-400">TV</span> PLAYER
          </h1>
        </div>

        {/* Login Card */}
        <div className="bg-slate-900/90 border-2 border-slate-800/80 rounded-2xl p-6.5 shadow-2xl backdrop-blur-md">
